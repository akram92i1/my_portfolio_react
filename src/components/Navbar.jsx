...
function Navbar() {
  ...
  return (
    ...
    <ul className='hidden md:flex'>
        ...
        <li className='p-5'>
            <Link to="portailAPI" smooth={true} duration={500} className="cursor-pointer">
                 Portail API 
            </Link>
        </li>
    </ul>
    ...
    <div className={nav ? 'fixed h-full left-0 top-0 w-[60%] bg-[#202121] ease-in-out duration-500' : 'fixed left-[-100%]'}>
        <h1 className='text-3xl primary-color m-4'>Akram KHELILI</h1>
        <ul className='p-8 text-2xl'>
            ...
            <li className='p-2'>
                <Link to="experience" smooth={true} duration={500} className="cursor-pointer" onClick={handleNav}>
                    Experience
                </Link>
            </li>
            <li className='p-2'>
